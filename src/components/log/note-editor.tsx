...
export function NoteEditor({ selectedDate }: { selectedDate: Date }) {
  ...
  return (
    <textarea
      ...
      className="w-full h-full p-3 font-display text-lg bg-transparent border border-border/30 rounded-lg resize-none focus:outline-none focus:border-secondary placeholder:text-muted"
    />
  );
}
