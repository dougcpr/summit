  ...
  return (
    <div className="flex gap-2">
      <button
        onClick={onAttempt}
        disabled={disabled}
        className="flex-1 flex items-center justify-center py-4 text-border border-2 border-border rounded-lg active:brightness-90 disabled:opacity-30 disabled:active:brightness-100"
